...
c3d 的 特点在于抽特征上，facebook 当时的训练资源下，都训练了1个月，提供了一个接口，可以用 c3d 的一个特征 $(4096)$，其他任务纷纷都用 c3d 的方法来抽特征，来做下游任务。和现在 transformer 做下游任务非常像，因为 transformer 的特征非常麻烦而且难以训练，现在都是给一个 pretrain 好的 model 然后来做下游的任务，做多模态的学习。这样训练的成本就低了很多。
